...
int main()
{
# variableName/Identifier Assignment Value
  ...
  cout<<"now Age is: "<<Age<<NewlineString<<"test\n";
  ...
  cout<<ConcatenateString1 + ConcatenateString2<<"\n";

  char C1{'L'}, C2{'o'}, C3{'p'};
  cout<<C1 + C2 + 'o' + C3<<"\n";

  // The above 'o' is an ascii character. 
  return 0;
}
